...
def handle(bot: MyBot, message):
    ...
    if action == "CREATE_MESSAGE":
        ...
        msgview.data_parsed = bot.blaze.parse_message_data(msgview.data, msgview.category)
        ...
        if msgview.type == "message":
            ...
            msguser.user_type = cache.get_user_type_by_mixin_user_id(bot, msguser.user_id)
            (msguser.mm_addr_type, msguser.mm_addr_uid,) = cache.get_user_addr_by_mixin_conversation(bot, msgview.conversation_id, msgview.user_id)
