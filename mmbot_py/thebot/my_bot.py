...
class MyBot:
    ...
    def send_button_group_message(self, buttons, conversation_id, quote_message_id=None):
        self.blaze.send_message(
            pack_message(
    ...
    @staticmethod
    def add_replying_text_message(ctx: MessageHandlerContext, text, quote_current_msg=False):
